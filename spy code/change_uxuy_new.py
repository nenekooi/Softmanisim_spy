...
def convert_curvatures_to_ode_action(ux, uy, length_change, d, L0_seg):  #d=cable_distance
    """将曲率转换为 ODE action。"""
    l = L0_seg
...
if __name__ == "__main__":
    ...
    OUTPUT_RESULTS_PATH = 'D:/data/save_data/circle(u_new_4,cab=0.04,k=-20,a=1).xlsx'
