...
if __name__ == "__main__":
    ...
    OUTPUT_RESULTS_PATH = os.path.join(output_dir, 'Simulated_Data_20250415_cable_d_0.004 .xlsx') # <<< 修改输出文件名以区分

    # 3. 机器人物理参数
    num_cables = 3
    cable_distance = 0.004 # 单位: 米
    initial_length = 0.12   # 单位: 米
    number_of_segment = 1
